...
class UserSearchResult:
    def __init__(self, myRow):
        ...
        Name = Label(newWindow, text="User's Name : ", font=("Times New Roman", 14))
        ...
        Address = Label(newWindow, text="User's Password : ", font=("Times New Roman", 14))
        ...
        BType = Label(newWindow, text="Gender : ", font=("Times New Roman", 14))
        ...
        AType = Label(newWindow, text="Address : ", font=("Times New Roman", 14))
        ...
        ASqft = Label(newWindow, text="Date Of Birth : ", font=("Times New Roman", 14))
        ...
        Location = Label(newWindow, text="Contact No. : ", font=("Times New Roman", 14))
