...
class Sell:
    def __init__(self, LoginID):
        ...
        myWall = ImageTk.PhotoImage(Image.open("sellInside.jpg"))
        ...
        def toSubmit():
            ...
            if len(Cno) < 10:
                ...
                try:
                    ...
                    Check4 = int(Cno)
                    try:
                        my = "insert into mysell values(%s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s)"
        ...
        IdLabel = Label(newWindow, text="Sell ID : ", font=("Times New Roman", 14))
        ...
        NameLabel = Label(newWindow, text="Seller's Name : ", font=("Times New Roman", 14))
        ...
        AddressLabel = Label(newWindow, text="Seller's Address : ", font=("Times New Roman", 14))
